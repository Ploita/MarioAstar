...
O = Tree('O', None,None,5,1,False,False)
N = Tree('N', None,None,5,1,True,False)
M = Tree('M', None,None,4,2,False,False)
L = Tree('L', None,None,4,2,False,False)
K = Tree('K', None,None,3,3,False,False)
J = Tree('J', None,None,3,3,False,False)
I = Tree('I', None,None,3,3,False,False)
H = Tree('H', None,None,3,3,False,False)
G = Tree('G', [K],None,2,4,False,False)
F = Tree('F', [],None,2,4,False,False)
...
temp = [[filho.g + filho.h, filho] for filho in A.filhos]
